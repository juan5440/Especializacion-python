...
p = Persona('alicia','hernandez', 27, '123456789')
print(p)
print(f'el nombre es: {p.nombres}')
print(f'los apellidos son: {p._apellidos}') 
# en python el ambito protegido no se cumple
# print(f'la edad es:  {p.__edad}') 
# atributo privado, solo disponible dentro de la misma clase
print(f'la edad es: {p.get_edad()}')
p.nombres = "ALICIA"
p.set_edad(20)
p.mostrar_datos()
print('*************************************************')
p_beto = Persona('beto', 'garcia', 25, '5435345345')
