...
print(f'el sueldo de {e1.nombres} es: {e1.calcular_sueldo()}')
print(f'el sueldo de {e2.nombres} es: {e2.calcular_sueldo()}')
print(f'el sueldo de {e3.nombres} es: {e3.calcular_sueldo()}')
